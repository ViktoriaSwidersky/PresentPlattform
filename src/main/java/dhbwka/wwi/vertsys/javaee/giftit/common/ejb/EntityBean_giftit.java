 ...
 */
package dhbwka.wwi.vertsys.javaee.giftit.common.ejb;
 ...
 */
public abstract class EntityBean_giftit<Entity, EntityId> {
     ...
     */
    public EntityBean_giftit(Class<Entity> entityClass) {
