 ...
 */
@Entity
public class Gift_giftit implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "gift_ids")
    @TableGenerator(name = "gift_ids", initialValue = 0, allocationSize = 50)
    private long id;
    ...
    @NotNull
    private GiftStatus status = GiftStatus.IDEA;
